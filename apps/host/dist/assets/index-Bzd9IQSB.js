...
'cardA':{url:'http://localhost:4173/assets/remoteEntry.js',format:'esm',from:'vite'},
  'promptManager':{url:'http://localhost:4175/assets/remoteEntry.js',format:'esm',from:'vite'}
                ...
                const wrapShareModule = remoteFrom => {
                  return merge({
                    'react':{'19.1.0':{get:()=>get(new URL('__federation_shared_react-uocnGSER.js', import.meta.url).href, remoteFrom), loaded:1}},'react-dom':{'19.1.0':{get:()=>get(new URL('__federation_shared_react-dom-CL5_CR4f.js', import.meta.url).href, remoteFrom), loaded:1}}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "app-main", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shared-ui-section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Shared UI Components" }),
